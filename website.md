...
projectURL: cryptex
descriptionShort: A multi-tenant crypto algorithmic trading platform: a Kafka event pipeline feeding OMS/EMS microservices, with full observability.
...
viewProjectUrl:
projectImg: /project-image/cryptex.svg
technologies:
  - Python
  - C#
  - .NET
